...
function updateMobileSidebarState(isOpen) {
    ...
    document.querySelector('.toggle-sidebar-btn')?.setAttribute('aria-expanded', String(isOpen));
}
...
function toggleMobileSidebar() {
    ...
    updateMobileSidebarState(!sidebar.classList.contains('mobile-open'));
}
...
function initMobileSidebar() {
    // Keep the off-canvas state and page scrolling in sync across breakpoints.
    updateMobileSidebarState(false);
}
...
// Settings is opened from an inline navigation item, so close the drawer here too.
document.addEventListener('click', function(e) {
